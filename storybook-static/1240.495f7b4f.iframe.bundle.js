    ...
    [1240],
    {
      ...
      './src/components/ConfirmationCodeInput/index.tsx': (
        ...
        var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ =
          ...
          _Icons_CheckCircleOutline__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
        ...
        const SacredGlyphs = () => {
            const glyphStyles = (0, react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(
              () => ({
                decorativeGlyph: (top, side, delay) => ({
                  position: 'absolute',
                  top,
                  [side]: side,
              ...
              react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment,
              {
                children: [
                  (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                    'div',
                    {
                      style: glyphStyles.decorativeGlyph('0.5rem', 'left'),
                      children: _theme__WEBPACK_IMPORTED_MODULE_4__.vR[8],
                    }
                  ),
                  (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                    'div',
                    {
                      style: glyphStyles.decorativeGlyph(
                        '0.5rem',
                        'right',
                        '3s'
                      ),
                      children: _theme__WEBPACK_IMPORTED_MODULE_4__.vR[12],
                    }
                  ),
                ],
              }
          ...
          SacredSuccessDecorations = () => {
            ...
            react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(
              () => ({
                ...
                glyph: i => ({
                  ...
                  fontSize: '1.25rem',
                  animation: `sacred-glyph-float ${3 + 0.5 * i}s infinite alternate`,
                }),
              }),
              []
            )
            return (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
              'div',
              {
                style: decorativeStyles.glyphContainer,
                children: ['𓅨', '𓂋', '𓏭'].map((glyph, i) =>
                  (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                    'span',
                    { style: decorativeStyles.glyph(i), children: glyph },
                    i
                  )
                ),
              }
          ...
          SacredBottomDecorations = () => {
            ...
            return (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
              'div',
              {
                style: decorativeStyles.bottomGlyphContainer,
                children: [...Array(3)].map((_, i) =>
                  (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                    'span',
                    { style: decorativeStyles.bottomGlyph, children: '.' },
                    i
                  )
                ),
              }
            ...
            const handleInputChange = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
                (e, index) => {
                  ...
                  let newValueArr = internalValue
                    .padEnd(codeLength, '')
                    .split('')
                  val.length > 1
                    ? val.split('').forEach((digit, i) => {
                        index + i < codeLength &&
                          (newValueArr[index + i] = digit)
                      })
                  ...
                  ;(setInternalValue(newValue),
                    ...
                    val &&
                      index < codeLength - 1 &&
                      (null ===
                        (_inputRefs_current_ = inputRefs.current[index + 1]) ||
                        void 0 === _inputRefs_current_ ||
                        _inputRefs_current_.focus()))
                },
                  ...
                  switch (e.key) {
                    ...
                    case 'ArrowRight':
                      ...
                      if (index < codeLength - 1)
                        (e.preventDefault(),
                          null ===
                            (_inputRefs_current_1 =
                              inputRefs.current[index + 1]) ||
                            void 0 === _inputRefs_current_1 ||
                            _inputRefs_current_1.focus())
                      break
                    case 'Enter':
                      index === codeLength - 1 &&
                        internalValue.length >= codeLength &&
                        onVerify &&
                        (e.preventDefault(), onVerify())
                      break
                    default:
                      if (/^\d$/.test(e.key)) {
                        var _inputRefs_current_2
                        e.preventDefault()
                        const newValueArr = internalValue
                          .padEnd(codeLength, '')
                          .split('')
                        ...
                        ;(setInternalValue(newValue),
                          ...
                          index < codeLength - 1 &&
                            (null ===
                              (_inputRefs_current_2 =
                                inputRefs.current[index + 1]) ||
                              void 0 === _inputRefs_current_2 ||
                              _inputRefs_current_2.focus()))
                      }
                  }
                },
                [internalValue, codeLength, onChange, onVerify]
              ),
              handlePaste = (0, react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
                (e, index) => {
                  e.preventDefault()
                  ...
                  if (digits) {
                    ...
                    null ===
                      (_inputRefs_current_focusIndex =
                        inputRefs.current[focusIndex]) ||
                      void 0 === _inputRefs_current_focusIndex ||
                      _inputRefs_current_focusIndex.focus()
                  }
                },
                [internalValue, codeLength, onChange]
              ),
              ...
              digits = internalValue.padEnd(codeLength, '').split(''),
              allFieldsFilled = internalValue.length >= codeLength
            return showSuccessState
              ? (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
                  'div',
                  {
                    ...
                    children: [
                      (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                        _Icons_CheckCircleOutline__WEBPACK_IMPORTED_MODULE_2__.A,
                        ...
                        'div',
                        {
                          ...
                          children: [
                            ...
                            react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
                              'div',
                              {
                                style: computedStyles.inputsRow,
                                children: [
                                  (0,
                                  react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                                    'div',
                                    {
                                      style: computedStyles.inputGroup,
                                      children: Array.from({
                                        length: codeLength,
                                      }).map((_, index) =>
                                        (0,
                                    ...
                                    showSendResendButton &&
                                      ...
                                      react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                                        _Button__WEBPACK_IMPORTED_MODULE_3__.A,
                                        {
                                          ...
                                          ...sendResendButtonProps,
                                          onClick: () =>
                                            onSendResend && void onSendResend(),
                                        }
                                      ),
                                    (0,
                                    react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
        ...
        ConfirmationCodeInputs.__docgenInfo = {
          ...
          props: {
            ...
            styles: {
              required: !1,
              tsType: { name: 'ConfirmationCodeInputStyles' },
              description:
                'Comprehensive styling options including theme, custom colors, and layout properties.',
            },
          },
