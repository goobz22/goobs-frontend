    ...
    [450],
    {
      './src/components/Icons/Delete.tsx': (
        ...
        const SACRED_GLYPHS = [
          ...
          DeleteIcon = ({ sacredtheme = !1, style = {}, ...props }) => {
          ...
          __WEBPACK_DEFAULT_EXPORT__ = DeleteIcon
        DeleteIcon.__docgenInfo = {
          description: '',
          methods: [],
      ...
      './src/components/Icons/Download.tsx': (
        ...
        const SACRED_GLYPHS = [
          ...
          sacredStyles_glyphVisible = { opacity: 1 },
          DownloadIcon = ({ sacredtheme = !1, style = {}, ...props }) => {
            const [isHovered, setIsHovered] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1),
              [glyph] = (0, react__WEBPACK_IMPORTED_MODULE_1__.useState)(
                SACRED_GLYPHS[Math.floor(Math.random() * SACRED_GLYPHS.length)]
          ...
          __WEBPACK_DEFAULT_EXPORT__ = DownloadIcon
      ...
      './src/components/Icons/Edit.tsx': (
        ...
        const SACRED_GLYPHS = [
          ...
          sacredStyles_glyphVisible = { opacity: 1 },
          EditIcon = ({ sacredtheme = !1, style = {}, ...props }) => {
            const [isHovered, setIsHovered] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1),
              [glyph] = (0, react__WEBPACK_IMPORTED_MODULE_1__.useState)(
                SACRED_GLYPHS[Math.floor(Math.random() * SACRED_GLYPHS.length)]
          ...
          __WEBPACK_DEFAULT_EXPORT__ = EditIcon
        EditIcon.__docgenInfo = {
          description: '',
          methods: [],
      ...
      './src/components/Icons/FileCopy.tsx': (
        ...
        const SACRED_GLYPHS = [
          ...
          sacredStyles_glyphVisible = { opacity: 1 },
          FileCopyIcon = ({ sacredtheme = !1, style = {}, ...props }) => {
            const [isHovered, setIsHovered] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1),
              [glyph] = (0, react__WEBPACK_IMPORTED_MODULE_1__.useState)(
                SACRED_GLYPHS[Math.floor(Math.random() * SACRED_GLYPHS.length)]
          ...
          __WEBPACK_DEFAULT_EXPORT__ = FileCopyIcon
        FileCopyIcon.__docgenInfo = {
          description: '',
          methods: [],
          displayName: 'FileCopyIcon',
          props: {
            sacredtheme: {
              required: !1,
              tsType: { name: 'boolean' },
