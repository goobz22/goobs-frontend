      ...
      './src/components/QRCode/qrcode.stories.tsx': (
        ...
        ;(__webpack_require__.r(__webpack_exports__),
          __webpack_require__.d(__webpack_exports__, {
            ...
            LightWithBothButtons: () => LightWithBothButtons,
            LightWithButton: () => LightWithButton,
            LightWithConfirmation: () => LightWithConfirmation,
            Sacred: () => Sacred,
            SacredSendResendAndVerify: () => SacredSendResendAndVerify,
            SacredSuccess: () => SacredSuccess,
            SacredWithBothButtons: () => SacredWithBothButtons,
            SacredWithMysticalElements: () => SacredWithMysticalElements,
            SendResendAndVerify: () => SendResendAndVerify,
        ...
        var jsx_runtime = __webpack_require__(
          ...
          otplib = __webpack_require__('./node_modules/otplib/index.js'),
        ...
        const qrCodeThemes = {
            light: {
              ...
              successIcon: { width: '60px', height: '60px', color: '#22C55E' },
              successMessage: {
                textAlign: 'center',
                fontFamily: 'Merriweather, serif',
                fontSize: '1.25rem',
            ...
            sacred: {
              ...
              errorContainer: { padding: '1rem' },
              errorText: { fontFamily: 'Cinzel, serif', color: '#FFD700' },
              glyph: {
                position: 'absolute',
                top: '0.5rem',
                right: '0.5rem',
          ...
          getQRCodeStyles = (styles, responsiveSize) => {
            const themeConfig = (styles => {
                const theme =
                    (null == styles ? void 0 : styles.theme) || 'light',
                  baseTheme = qrCodeThemes[theme]
                return styles
                  ? {
                      ...baseTheme,
                      container: {
                        ...
                        maxWidth:
                          styles.maxWidth || baseTheme.container.maxWidth,
                      },
                      title: {
                        ...baseTheme.title,
                        color: styles.titleColor || baseTheme.title.color,
                        fontSize:
                          styles.titleFontSize || baseTheme.title.fontSize,
                        fontWeight:
                          styles.titleFontWeight || baseTheme.title.fontWeight,
                      },
                      qrCodeContainer: {
                        ...baseTheme.qrCodeContainer,
                        backgroundColor:
                          styles.qrBackgroundColor ||
                          baseTheme.qrCodeContainer.backgroundColor,
                        border: styles.qrBorderColor
                          ? `1px solid ${styles.qrBorderColor}`
                          : baseTheme.qrCodeContainer.border,
                        boxShadow:
                          styles.qrBoxShadow ||
                          baseTheme.qrCodeContainer.boxShadow,
                      },
                      infoText: {
                        ...baseTheme.infoText,
                      ...
                      errorText: {
                        ...baseTheme.errorText,
                        color:
                          styles.errorTextColor || baseTheme.errorText.color,
                      },
                      glyph: {
                        ...baseTheme.glyph,
                        display: styles.showGlyphs
                          ? 'block'
                          : baseTheme.glyph.display,
                      },
                      decorativeGlyphs: {
                        ...baseTheme.decorativeGlyphs,
                        display: styles.showGlyphs
                          ? 'flex'
                          : baseTheme.decorativeGlyphs.display,
                      },
              ...
              size =
                responsiveSize ||
                (null == styles ? void 0 : styles.size) ||
                256,
              containerStyle = {
        ...
        var Button = __webpack_require__('./src/components/Button/index.tsx'),
          ...
          ConfirmationCodeInput = __webpack_require__(
            './src/components/ConfirmationCodeInput/index.tsx'
          ),
          console = __webpack_require__(
            './node_modules/console-browserify/index.js'
          )
        const QRCodeComponent = react.memo(
          ({
            username,
            appName = 'ThothOS',
            size = 256,
            ...
            showConfirmationInput = !1,
            confirmationCode = '',
            onConfirmationCodeChange,
            confirmationCodeProps = {},
            styles,
          }) => {
            const { secret, otpAuth } = (0, react.useMemo)(() => {
              const generatedSecret = otplib.authenticator.generateSecret()
              return {
                secret: generatedSecret,
                otpAuth: otplib.authenticator.keyuri(
                  username,
                  appName,
                  generatedSecret
                ),
            ...
            ;(0, react.useEffect)(() => {
              onSecretGenerated && secret && onSecretGenerated(secret)
            }, [secret, onSecretGenerated])
            const responsiveSize = (0, react.useMemo)(
                () => Math.min(size, window.innerWidth - 32),
                [size]
              ),
              computedStyles = getQRCodeStyles(styles, responsiveSize)
            return otpAuth
              ? showSuccessState
                ? (0, jsx_runtime.jsxs)('div', {
                    style: computedStyles.successContainer,
                    children: [
                      ...
                      (0, jsx_runtime.jsx)(CheckCircle.A, {
                        style: computedStyles.successIcon,
                      }),
                      (0, jsx_runtime.jsx)('h5', {
                        style: computedStyles.successMessage,
                ...
                : (0, jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, jsx_runtime.jsx)('div', {
                        style: computedStyles.infoText,
                        children: `${appName}: ${username}`,
                      }),
                      showConfirmationInput &&
                        (0, jsx_runtime.jsx)('div', {
                          style: computedStyles.confirmationContainer,
                      ...
                      showVerifyButton &&
                        (0, jsx_runtime.jsx)('div', {
                          ...
                          children: (0, jsx_runtime.jsx)(Button.A, {
                            ...
                            onClick: () => {
                              const result =
                                null == onVerify ? void 0 : onVerify()
                              result instanceof Promise &&
                                result.catch(console.error)
                            },
                            disabled:
                              (null == verifyButtonProps
                                ? void 0
                      ...
                      'sacred' === (null == styles ? void 0 : styles.theme) &&
                        (0, jsx_runtime.jsx)('div', {
                          style: computedStyles.decorativeGlyphs,
                          children: ['𓂀', '𓊖', '𓏏'].map((glyph, i) =>
                            (0, jsx_runtime.jsx)(
                              'span',
                              {
                                style: {
              ...
              : (0, jsx_runtime.jsx)('div', {
                  style: computedStyles.errorContainer,
                  role: 'alert',
        ...
        QRCodeComponent.__docgenInfo = {
          ...
          props: {
            username: {
              required: !0,
              tsType: { name: 'string' },
              description: 'The username for the QR code',
            },
            appName: {
              required: !1,
              tsType: { name: 'string' },
              description: 'The app name for the QR code',
              defaultValue: { value: "'ThothOS'", computed: !1 },
            },
            size: {
              required: !1,
              tsType: { name: 'number' },
            ...
            title: {
              required: !1,
              tsType: { name: 'string' },
              description: 'The title to display above the QR code',
            },
            onSecretGenerated: {
              required: !1,
              tsType: {
              ...
              description: 'Callback when the secret is generated',
            },
            showVerifyButton: {
              required: !1,
              tsType: { name: 'boolean' },
              description: 'Whether to show the verify button',
              defaultValue: { value: 'false', computed: !1 },
            },
            onVerify: {
              required: !1,
              ...
              description: 'Callback when verify is clicked',
            },
            onDisableVerification: {
              required: !1,
              tsType: {
              ...
              description: 'Callback when disable verification is clicked',
            },
            verifyButtonProps: {
              required: !1,
              tsType: {
                ...
                raw: 'Partial<ButtonProps>',
              },
              description: 'Props for the verify button',
              defaultValue: { value: '{}', computed: !1 },
            },
            disableVerificationButtonProps: {
              required: !1,
              ...
              description: 'Props for the disable verification button',
              defaultValue: { value: '{}', computed: !1 },
            },
            showSuccessState: {
              required: !1,
              tsType: { name: 'boolean' },
              description: 'Whether to show the success state',
              defaultValue: { value: 'false', computed: !1 },
            },
            successMessage: {
              required: !1,
            ...
            showConfirmationInput: {
              required: !1,
              tsType: { name: 'boolean' },
              description: 'Whether to show the confirmation input',
              defaultValue: { value: 'false', computed: !1 },
            },
            confirmationCode: {
              required: !1,
              tsType: { name: 'string' },
              description: 'The confirmation code value',
              defaultValue: { value: "''", computed: !1 },
            },
            onConfirmationCodeChange: {
              required: !1,
              ...
              description: 'Callback when confirmation code changes',
            },
            confirmationCodeProps: {
              required: !1,
              tsType: {
                name: 'Partial',
                elements: [{ name: 'ConfirmationCodeInputsProps' }],
                raw: 'Partial<ConfirmationCodeInputsProps>',
              },
              description: 'Props for the confirmation code input',
              defaultValue: { value: '{}', computed: !1 },
            },
            styles: {
              required: !1,
              tsType: { name: 'QRCodeStyles' },
              description: 'Custom styles to apply using the theme system',
            },
          },
        }
        var qrcode_stories_console = __webpack_require__(
          './node_modules/console-browserify/index.js'
        )
        const qrcode_stories = {
          ...
          LightWithConfirmation = {
            ...
            args: {
              ...
              showVerifyButton: !0,
              showConfirmationInput: !0,
              confirmationCode: '123456',
              styles: { theme: 'light' },
            },
          },
          LightWithBothButtons = {
          ...
          LightCustomSize = {
            ...
            args: {
              ...
              title: 'Large QR Code',
              size: 320,
              styles: { theme: 'light', maxWidth: '400px' },
            },
          },
          Dark = {
            name: 'Dark/Basic',
          ...
          SacredWithMysticalElements = {
            ...
            args: {
              ...
              showVerifyButton: !0,
              styles: { theme: 'sacred', showGlyphs: !0 },
              verifyButtonProps: { text: '✨ Activate Sacred Shield' },
            },
            parameters: { backgrounds: { default: 'dark' } },
          },
          SacredWithBothButtons = {
          ...
          CustomSizing = {
            ...
            args: {
              ...
              size: 200,
              styles: { theme: 'light', padding: '2rem', maxWidth: '500px' },
            },
          },
          SendResendVerifyComponent = () => {
            const [codeSent, setCodeSent] = (0, react.useState)(!1),
              [code, setCode] = (0, react.useState)(''),
              [showSuccess, setShowSuccess] = (0, react.useState)(!1),
              handleDisable = () => {
                ;(setShowSuccess(!1), setCodeSent(!1), setCode(''))
              }
            return showSuccess
              ? (0, jsx_runtime.jsx)(QRCode, {
              ...
              : (0, jsx_runtime.jsx)(QRCode, {
                  ...
                  confirmationCodeProps: {
                    ...
                    onSendResend: () => {
                      ;(setCodeSent(!0),
                        setCode(''),
                        qrcode_stories_console.log(
                          codeSent ? 'Resending code...' : 'Sending code...'
                        ))
                    },
                    onVerify: () => {
                      6 === code.length && setShowSuccess(!0)
                    },
                  },
                  styles: { theme: 'light' },
                })
          ...
          SendResendAndVerify = {
            ...
            render: () => (0, jsx_runtime.jsx)(SendResendVerifyComponent, {}),
          },
          SacredSendResendVerifyComponent = () => {
            const [codeSent, setCodeSent] = (0, react.useState)(!1),
              [code, setCode] = (0, react.useState)(''),
              [showSuccess, setShowSuccess] = (0, react.useState)(!1),
              handleDisable = () => {
            ...
            return showSuccess
              ...
              : (0, jsx_runtime.jsx)(QRCode, {
                  ...
                  confirmationCodeProps: {
                    ...
                    verifyButtonProps: { text: '✨ Verify Sacred Code' },
                  },
                  styles: { theme: 'sacred' },
                })
          },
          SacredSendResendAndVerify = {
            name: 'Sacred/Send/Resend + Verify Buttons',
            render: () =>
              (0, jsx_runtime.jsx)(SacredSendResendVerifyComponent, {}),
            parameters: { backgrounds: { default: 'dark' } },
          },
          InteractiveSetupComponent = () => {
            const [step, setStep] = (0, react.useState)('qr'),
              [code, setCode] = (0, react.useState)(''),
              handleVerify = () => {
                6 === code.length && setStep('success')
              },
              handleDisable = () => {
                ;(setStep('qr'), setCode(''))
              }
            return 'success' === step
              ...
              : (0, jsx_runtime.jsx)(QRCode, {
                  ...
                  title: 'Setup Two-Factor Authentication',
                  showVerifyButton: !0,
                  showConfirmationInput: 'verify' === step,
                  confirmationCode: code,
                  onConfirmationCodeChange: setCode,
                  onVerify: handleVerify,
                  verifyButtonProps: {
                    onClick: () => {
                      'qr' === step ? setStep('verify') : handleVerify()
                    },
                    text:
                      'qr' === step
                        ? 'Continue to Verification'
                        : 'Verify Code',
                    disabled: 'verify' === step && code.length < 6,
                  },
                  styles: { theme: 'light' },
                })
          },
          InteractiveSetup = {
            ...
            render: () => (0, jsx_runtime.jsx)(InteractiveSetupComponent, {}),
          },
          ErrorState = {
            name: 'States/Error',
            render: () =>
          ...
          InteractionTest = {
            ...
            play: async ({ canvasElement }) => {
              const canvas = (0, dist.ux)(canvasElement),
                qrCode = canvas.getByTestId('mfa-qrcode')
              await (0, dist.E3)(qrCode).toBeVisible()
              const title = canvas.getByText('Test QR Code')
              await (0, dist.E3)(title).toBeVisible()
              const infoText = canvas.getByText('TestApp: test@example.com')
              await (0, dist.E3)(infoText).toBeVisible()
              const verifyButton = canvas.getByText('Verify Code')
              await (0, dist.E3)(verifyButton).toBeVisible()
            },
          },
          __namedExportsOrder = [
            'Light',
