      ...
      './src/components/Field/Percentage/percentagefield.stories.tsx': (
        ...
        ;(__webpack_require__.r(__webpack_exports__),
          __webpack_require__.d(__webpack_exports__, {
            ...
            default: () => percentagefield_stories,
          }))
        ...
        const PercentageField = ({
            ...
            const initialValueString =
              ...
              valueSpanRef = (0, react.useRef)(null),
              placeholderSpanRef = (0, react.useRef)(null),
              [inputContentWidth, setInputContentWidth] = (0, react.useState)(
                0
              ),
              computedStyles = ((styles, isFocused) => {
                ...
                return {
                  ...
                  input: {
                    ...
                    paddingRight:
                      (null == styles ? void 0 : styles.paddingRight) || '60px',
                    paddingTop:
              ...
              displayValue =
                showPercentSymbol && currentValue
                  ? `${currentValue}%`
                  : currentValue,
              measureStyle = {
                position: 'absolute',
            ...
            ;(0, react.useEffect)(() => {
              let valueWidth = 0,
                placeholderWidth = 0
              ;(valueSpanRef.current &&
                (valueWidth = valueSpanRef.current.offsetWidth),
                placeholderSpanRef.current &&
                  placeholder &&
                  (placeholderWidth = placeholderSpanRef.current.offsetWidth),
                setInputContentWidth(Math.max(valueWidth, placeholderWidth)))
            }, [displayValue, placeholder])
            const calculatedWidth = `${inputContentWidth + (parseFloat(String(computedStyles.input.paddingLeft || '0')) || 0) + (parseFloat(String(computedStyles.input.paddingRight || '0')) || 0) + 1}px`,
              clearTimers = (0, react.useCallback)(() => {
                ;(initialTimerRef.current &&
                  clearTimeout(initialTimerRef.current),
                  timerRef.current && clearInterval(timerRef.current))
              }, []),
              formatValue = (0, react.useCallback)(
                val => {
              ...
              handleIncrement = (0, react.useCallback)(() => {
                const num = parseFloat(value || internalValue || '0'),
                  newValue =
                    void 0 !== max
                      ? Math.min(max, (isNaN(num) ? 0 : num) + step)
                      : (isNaN(num) ? 0 : num) + step,
                  newValueStr = formatValue(newValue.toString())
              ...
              handleDecrement = (0, react.useCallback)(() => {
                const num = parseFloat(value || internalValue || '0'),
                  newValue = Math.max(min, (isNaN(num) ? 0 : num) - step),
                  newValueStr = formatValue(newValue.toString())
                ;(setInternalValue(newValueStr),
                  null == onChange || onChange(newValue))
            ...
            const handleChange = (0, react.useCallback)(
                event => {
                  const numericInput = event.target.value.replace(/%/g, ''),
                    formattedValue = formatValue(numericInput)
                  setInternalValue(formattedValue)
                  const clonedEvent = {
                    ...event,
                    target: { ...event.target, value: formattedValue },
                  }
                  null == onChange || onChange(clonedEvent)
                },
                [onChange, formatValue]
              ),
              handleFocus = (0, react.useCallback)(() => setIsFocused(!0), []),
              handleBlur = (0, react.useCallback)(() => setIsFocused(!1), []),
              EndAdornment = () =>
                (0, jsx_runtime.jsx)('div', {
                  style: computedStyles.adornmentContainer,
            ...
            return (0, jsx_runtime.jsxs)('div', {
              style: {
                ...
                width: (null == styles ? void 0 : styles.width) || 'auto',
              },
              children: [
                label &&
                ...
                (0, jsx_runtime.jsxs)('div', {
                  style: { ...computedStyles.inputWrapper, width: 'auto' },
                  children: [
                    ...
                    (0, jsx_runtime.jsx)(EndAdornment, {}),
                  ],
                }),
                helperText &&
                  (0, jsx_runtime.jsx)('div', {
        ...
        PercentageField.__docgenInfo = {
          description: '',
          methods: [],
          displayName: 'PercentageField',
          props: {
            initialValue: {
              required: !1,
              tsType: {
        ...
        const PercentageFieldWithState = ({ initialValue = '', ...props }) => {
            ...
            return (0, jsx_runtime.jsx)(Percentage, {
              ...props,
              value,
              onChange: event => {
                setValue(
          ...
          LightTheme = {
            ...
            render: () =>
              (0, jsx_runtime.jsx)(PercentageFieldWithState, {
                label: 'Percentage',
          ...
          PercentageValidationDemo = () => {
            const [percentage, setPercentage] = (0, react.useState)(''),
            ...
            return (0, jsx_runtime.jsxs)('div', {
              ...
              children: [
                (0, jsx_runtime.jsx)('h3', {
                  ...
                  children: 'Percentage Validation',
                }),
                (0, jsx_runtime.jsx)(Percentage, {
                  ...
                  onChange: event => {
                    const value =
                      'number' == typeof event
                        ? event.toString()
                        : event.target.value
                    ;(setPercentage(value), error && validatePercentage(value))
                  },
                  helperText: error,
                ...
                (0, jsx_runtime.jsx)('button', {
                  ...
                  children: 'Validate Percentage',
                }),
                (0, jsx_runtime.jsxs)('div', {
                  style: { fontSize: '14px', color: '#6B7280' },
                  children: [
                    (0, jsx_runtime.jsx)('p', {
                      children: 'Percentage validation rules:',
                    }),
          ...
          ValidationDemo = {
            ...
            render: () => (0, jsx_runtime.jsx)(PercentageValidationDemo, {}),
          },
          InteractionTest = {
            ...
            play: async ({ canvasElement }) => {
              const canvas = (0, dist.ux)(canvasElement),
                input = canvas.getByPlaceholderText(
                  'Enter percentage for testing'
                ),
                label = canvas.getByText('Test Percentage Input')
              ;((0, dist.E3)(label).toBeVisible(),
                (0, dist.E3)(input).toBeVisible(),
                await dist.Q4.click(input),
                await dist.Q4.type(input, '75.5', { delay: 50 }),
                await (0, dist.E3)(input).toHaveValue('75.5'))
            },
          },
          __namedExportsOrder = [
            'LightTheme',
