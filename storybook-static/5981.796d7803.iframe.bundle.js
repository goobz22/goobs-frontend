    ...
    [5981],
    {
      './src/components/Field/Date/DateRange/index.tsx': (
        ...
        var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ =
          ...
          _Icons_Calendar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
            './src/components/Icons/Calendar.tsx'
          ),
          _Icons_ArrowBack__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
            './src/components/Icons/ArrowBack.tsx'
          ),
          _theme__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
            './src/theme/index.ts'
          ),
          _Dropdown_Regular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
        ...
        const MONTHS = [
          ...
          DateRangeComponent = ({
            ...
            const formatDate = date =>
                date
                  ...
                  : '',
              [dateRange, setDateRange] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(
                value || { start: null, end: null }
              ),
              [isStartDateOpen, setIsStartDateOpen] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1),
              [isEndDateOpen, setIsEndDateOpen] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1),
              [startDateInputValue, setStartDateInputValue] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(
                formatDate(dateRange.start)
              ),
              [endDateInputValue, setEndDateInputValue] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(
                formatDate(dateRange.end)
              ),
              [activeSelection, setActiveSelection] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)('start'),
              [isFocused, setIsFocused] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1),
              popoverRef = (0, react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null),
              currentDate = new Date(),
              currentYear = currentDate.getFullYear(),
              currentMonth = currentDate.getMonth(),
              [viewedYear, setViewedYear] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(currentYear),
              [viewedMonth, setViewedMonth] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(currentMonth),
              [dragPosition, setDragPosition] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)({ x: 0, y: 0 }),
              [isDragging, setIsDragging] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1),
              [dragOffset, setDragOffset] = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useState)({ x: 0, y: 0 }),
              sacredtheme =
              ...
              pickerStyles = ((sacredtheme, isDragging) => ({
                ...
                grid7Col: { gridTemplateColumns: 'repeat(7, 1fr)' },
                pickerButton: {
                  padding: '0.5rem',
                  borderRadius: '9999px',
                  textAlign: 'center',
                ...
                confirmation: { textAlign: 'center', padding: '1rem' },
                confirmationText: {
                  fontSize: '1.125rem',
              ...
              }))(sacredtheme, isDragging),
              {
                ...
                footerTextColor,
                transition,
              } = (0, _theme__WEBPACK_IMPORTED_MODULE_4__.AW)(
                fieldStyles,
                isFocused
              ),
              componentStyles = {
                container: {
                  ...(0, _theme__WEBPACK_IMPORTED_MODULE_4__.ZZ)(fieldStyles),
                  display: 'flex',
                  alignItems: 'center',
                  gap: '1rem',
                },
                ...
                label: (0, _theme__WEBPACK_IMPORTED_MODULE_4__.Wh)(
                  labelColor,
                  themeConfig
                ),
                endAdornment: (0, _theme__WEBPACK_IMPORTED_MODULE_4__.EK)(
                  adornmentColor
                ),
                footerText: (0, _theme__WEBPACK_IMPORTED_MODULE_4__.En)(
                  footerTextColor,
                  themeConfig,
                  fieldStyles
                ),
            ...
            ;((0, react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
              ...
              (0, react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
                if (isStartDateOpen || isEndDateOpen) {
                  ...
                  const selected = isStartDateOpen
                    ? dateRange.start
                    : dateRange.end
                  selected
                    ? (setViewedYear(selected.getFullYear()),
                      setViewedMonth(selected.getMonth()))
                    : (setViewedYear(currentYear), setViewedMonth(currentMonth))
                }
              }, [
                isStartDateOpen,
                isEndDateOpen,
            ...
            const closePicker = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(() => {
                'start' === activeSelection
                  ? setIsStartDateOpen(!1)
                  : setIsEndDateOpen(!1)
              }, [activeSelection]),
              handleClickOutside = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
                event => {
                  popoverRef.current &&
            ...
            const handleStartDateChange = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
                date => {
                  if (date) {
                    ...
                    ;(dateRange.end &&
                      date > dateRange.end &&
                      ((newRange.end = null), setEndDateInputValue('')),
              ...
              handleEndDateChange = (0,
              react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
                date => {
                  date &&
                    (!dateRange.start || date > dateRange.start) &&
                    (setDateRange({ ...dateRange, end: date }),
                    onChange && onChange({ ...dateRange, end: date }))
                },
                [dateRange, onChange]
              ),
                  ...
                  if (!isNaN(month) && !isNaN(day) && !isNaN(year)) {
                    ...
                    if (
                      ...
                      if (
                        ...
                        disableFutureDateValidation || date > today)
                      )
                        return date
                    }
                  }
              ...
              handleDaySelect = day => {
                ...
                if ((date.setHours(0, 0, 0, 0), 'start' === activeSelection)) {
                                ...
                                children: [
                                  ...
                                  react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                                    'button',
                                    {
                                      ...
                                      children: (0,
                                      react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                                        _Icons_ArrowBack__WEBPACK_IMPORTED_MODULE_3__.A,
                                        {
                                          style: {
                                            height: '1.25rem',
                                            width: '1.25rem',
                                  ...
                                  react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(
                                    'div',
                                    {
                                      ...
                                      children: [
                                        (0,
                                        react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                                          _Dropdown_Regular__WEBPACK_IMPORTED_MODULE_5__.A,
                                          {
                                            options:
                    ...
                    children: [
                      ...
                      (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                        'div',
                        {
                          ...
                          children: (0,
                          react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                            _Icons_Calendar__WEBPACK_IMPORTED_MODULE_2__.A,
                            ...
                            children: [
                              ...
                              rest.required &&
                                ...
                                react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                                  ...
                                  {
                                    style: (0,
                                    _theme__WEBPACK_IMPORTED_MODULE_4__.sz)(
                                      fieldStyles
                                    ),
                                    children:
                                      (null == fieldStyles
                        ...
                        'div',
                        {
                          ...
                          children: [
                            ...
                            react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(
                              ...
                              {
                                ...rest,
                                ...(0, _theme__WEBPACK_IMPORTED_MODULE_4__.SI)(
                                  rest.required
                                ),
                                value,
                                ...
                                onKeyDown: e =>
                                  ((e, isStart) => {
                                      ...
                                      const selectedPart =
                                        pos <= 2
                                          ...
                                          : pos <= 5
                                            ? 'day'
                                            : 'year'
                                      if ('month' === selectedPart)
                                        month =
                                          ((month + inc - 1 + 12) % 12) + 1
                                      else if ('day' === selectedPart) {
                                    ...
                                    null ===
                                      (_rest_onKeyDown = rest.onKeyDown) ||
                                ...
                                placeholder:
                                  null !==
                                    (_rest_placeholder = rest.placeholder) &&
                ...
                children: [
                  createInputField(
                    ...
                    value => {
                      ...
                      parsed && handleStartDateChange(parsed)
                    },
                    e => {
                      ;(e.stopPropagation(),
                        setActiveSelection('start'),
                        setIsStartDateOpen(!0))
                    },
                    !0
                  ),
                  createInputField(
                    ...
                    value => {
                      ...
                      const parsed = parseDate(formatted)
                      parsed && handleEndDateChange(parsed)
                    },
                    e => {
                      ;(e.stopPropagation(),
          ...
          __WEBPACK_DEFAULT_EXPORT__ = DateRangeComponent
        DateRangeComponent.__docgenInfo = {
          description: '',
          methods: [],
          displayName: 'DateRangeComponent',
          props: {
            onChange: {
              required: !1,
              tsType: {
                name: 'signature',
                type: 'function',
                raw: '(dateRange: DateRange) => void',
                signature: {
                  arguments: [
                    { type: { name: 'DateRange' }, name: 'dateRange' },
                  ],
                  return: { name: 'void' },
                },
              },
            ...
            startLabel: {
              ...
              tsType: { name: 'string' },
              description: '',
              defaultValue: { value: "'Start Date'", computed: !1 },
            },
            endLabel: {
              required: !1,
              tsType: { name: 'string' },
              description: '',
              defaultValue: { value: "'End Date'", computed: !1 },
            },
            helperText: {
              required: !1,
              tsType: { name: 'string' },
