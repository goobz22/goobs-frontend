  ...
  ;(() => {
      ...
      Ut = ue(() => {
        ...
        ;((Ml = __STORYBOOK_CORE_EVENTS__),
          ({
            ...
            STORY_PREPARED: Pc,
            STORY_RENDERED: Rc,
            STORY_RENDER_PHASE_CHANGED: xc,
            STORY_SPECIFIED: On,
            STORY_THREW_EXCEPTION: _c,
            STORY_UNCHANGED: Ac,
            TELEMETRY_ERROR: Nc,
            TOGGLE_WHATS_NEW_NOTIFICATIONS: kc,
    ...
    var vf,
      ...
      An = ue(() => {
        ...
        Z()
        Q()
        ;((vf = __STORYBOOK_ICONS__),
          ({
            AccessibilityAltIcon: Ef,
            AccessibilityIcon: Of,
            AccessibilityIgnoredIcon: Sf,
            AddIcon: wf,
            AdminIcon: Tf,
            AlertAltIcon: If,
            AlertIcon: Cf,
            ...
            ArrowBottomRightIcon: Af,
            ArrowDownIcon: Nf,
            ArrowLeftIcon: kf,
            ArrowRightIcon: xn,
            ArrowSolidDownIcon: Lf,
            ArrowSolidLeftIcon: jf,
            ArrowSolidRightIcon: Mf,
            ArrowSolidUpIcon: Df,
            ArrowTopLeftIcon: Ff,
            ArrowTopRightIcon: Bf,
            ArrowUpIcon: Wf,
            AzureDevOpsIcon: Hf,
            BackIcon: Uf,
            BasketIcon: zf,
            ...
            BoldIcon: Kf,
            BookIcon: Jf,
            BookmarkHollowIcon: Xf,
            BookmarkIcon: Zf,
            BottomBarIcon: Qf,
            BottomBarToggleIcon: ed,
            BoxIcon: td,
            BranchIcon: nd,
            BrowserIcon: rd,
            ButtonIcon: od,
            ...
            ChevronLeftIcon: md,
            ChevronRightIcon: yd,
            ChevronSmallDownIcon: gd,
            ChevronSmallLeftIcon: bd,
            ChevronSmallRightIcon: vd,
            ChevronSmallUpIcon: Ed,
            ChevronUpIcon: Od,
            ChromaticIcon: Sd,
            ChromeIcon: wd,
            CircleHollowIcon: Td,
            ...
            CommitIcon: Md,
            CompassIcon: Dd,
            ComponentDrivenIcon: Fd,
            ComponentIcon: Bd,
            ContrastIcon: Wd,
            ContrastIgnoredIcon: Hd,
            ControlsIcon: Ud,
            CopyIcon: zd,
            CreditIcon: Gd,
            CrossIcon: Yd,
    ...
    function Do(e, t = {}) {
      ...
      function S(m, v) {
        let w = d(),
          U = g(a, w),
          x = (Ie, je) => m.style.setProperty(Ie, je + '')
        ;(x('--xlp', $t(Tt(qn(v, 90) - 180), 0, 180, -u / 2, u / 2) + 'px'),
          x('--dc', r - lt(1e3 * Ee()) + 'ms'))
        let z = Ee() < Bo ? ze(Ee() * Wo, 2) : 0
        ;(x('--x1', z),
          x('--x2', -1 * z),
          x('--x3', z),
          x('--x4', ze(Tt($t(Tt(qn(v, 90) - 180), 0, 180, -1, 1)), 4)),
          x('--y1', ze(Ee() * Gn, 4)),
          x('--y2', ze(Ee() * o * (Nr() ? 1 : -1), 4)),
          x('--y3', Gn),
          x('--y4', ze(Ho($t(Tt(v - 180), 0, 180, o, -o), 0), 4)),
          x('--w', (U ? s : lt(4 * Ee()) + s / 2) + 'px'),
          x('--h', (U ? s : lt(2 * Ee()) + s) + 'px'))
        let ee = w.toString(2).padStart(3, '0').split('')
        ;(x('--hr', ee.map(Ie => +Ie / 2 + '').join(' ')),
          x('--r', ee.join(' ')),
          x('--rd', ze(Ee() * (Fo - zn) + zn) + 'ms'),
          x('--br', U ? '50%' : 0))
      }
      let b
      function R() {
        ;((e.innerHTML = ''),
          ...
          (h = (function (m, v = [], w) {
            let U = []
            for (let { color: x } of v) {
              let z = Yt('div')
              ;((z.className = `${Nn} ${w}`), z.style.setProperty('--bgc', x))
              let ee = Yt('div')
              ;(qt(z, ee), qt(m, z), U.push(z))
            }
            return U
          })(e, f, c)))
        for (let [m, v] of $n(h)) S(v, f[+m].degree)
        b = setTimeout(() => {
          l && (e.innerHTML = '')
        }, r)
      }
      return (
        R(),
        {
          update(m) {
            ...
            let Ue = !1
            if (v === i) {
              h = Array.from(e.querySelectorAll(`.${Nn}`))
              for (let [et, { color: xe }] of $n(f)) {
                let _e = h[+et]
                ;(JSON.stringify(n) !== JSON.stringify(z) &&
                  _e.style.setProperty('--bgc', xe),
                  w !== a &&
                    _e.style.setProperty('--br', g(w, d()) ? '50%' : '0'),
                  x !== c &&
                    (c && _e.classList.remove(c), x && _e.classList.add(x)))
              }
            } else Ue = !0
            ;(l && !Me && clearTimeout(b),
    ...
    function Qn(e, t, n) {
      ...
      if (!_.nullOrUndefined(i)) {
        if (_.defined(c)) {
          if (_.array(c) || _.plainObject(c)) return ai(c, l, i)
        } else return oe(l, i)
        return !1
      }
    ...
    function tr(e) {
      return ([t, n]) =>
        _.array(e)
          ? oe(e, n) || e.some(r => oe(r, n) || (_.array(n) && an(n)(r)))
          : _.plainObject(e) && e[t]
            ? !!e[t] && oe(e[t], n)
            : oe(e, n)
    }
    ...
    function nr(e) {
      return t =>
        _.array(e)
          ? e.some(n => oe(n, t) || (_.array(t) && an(t)(n)))
          : oe(e, t)
    }
    function rt(e, t) {
    ...
    function Hr(e, t, n, r, o) {
      ...
      var a = cn(n, r, i, o),
        ...
        c = Object.keys(s)
          .map(function (f) {
            return le({ key: f }, s[f], { area: vi(s[f]) })
          })
          .sort(function (f, h) {
            return h.area - f.area
          }),
        l = c.filter(function (f) {
          var h = f.width,
            d = f.height
          return h >= n.clientWidth && d >= n.clientHeight
        }),
    ...
    function Ci() {
      this.state.eventsEnabled &&
        ...
        (this.state = Ii(this.reference, this.state)))
    }
    function pn(e) {
    ...
    function Ri(e) {
      return (
        ...
        e.arrowElement &&
          ...
          Qt(e.arrowElement, e.arrowStyles),
        e
      )
    }
    ...
    function Ni(e, t) {
      var n = t.x,
        r = t.y,
        o = e.offsets.popper,
        i = ft(e.instance.modifiers, function (m) {
      ...
      var a = i !== void 0 ? i : t.gpuAcceleration,
        ...
        p = _i(e, window.devicePixelRatio < 2 || !Ai),
      ...
      if (
        ...
        f === 'right'
          ? s.nodeName === 'HTML'
            ? (d = -s.clientWidth + p.right)
            : (d = -c.width + p.right)
          : (d = p.left),
        a && h)
      )
        ((l[h] = 'translate3d(' + d + 'px, ' + g + 'px, 0)'),
          (l[u] = 0),
          (l[f] = 0),
        ...
        var S = u === 'bottom' ? -1 : 1,
          b = f === 'right' ? -1 : 1
        ;((l[u] = g * S), (l[f] = d * b), (l.willChange = u + ', ' + f))
      }
      var R = { 'x-placement': e.placement }
      return (
        (e.attributes = le({}, R, e.attributes)),
    ...
    function ki(e, t) {
      ...
      var g = s[u] + s[l] / 2 - d / 2,
        ...
        m = g - e.offsets.popper[u] - b - R
      return (
        (m = Math.max(Math.min(a[l] - d, m), 0)),
        (e.arrowElement = r),
        (e.offsets.arrow =
          ((n = {}), $e(n, u, Math.round(m)), $e(n, f, ''), n)),
        e
      )
    }
    function Li(e) {
    ...
    function Fi(e, t, n, r) {
      ...
      return (
        (l = l.map(function (p, u) {
          ...
          return p
            .reduce(function (d, g) {
              return d[d.length - 1] === '' && ['+', '-'].indexOf(g) !== -1
                ? ((d[d.length - 1] = g), (h = !0), d)
                : h
                  ? ((d[d.length - 1] += g), (h = !1), d)
                  : d.concat(g)
            }, [])
            .map(function (d) {
              return Di(d, f, t, n)
        ...
        l.forEach(function (p, u) {
          p.forEach(function (f, h) {
            pn(f) && (o[u] += f * (p[h - 1] === '-' ? -1 : 1))
          })
        }),
        o
      )
    ...
    function Wi(e, t) {
      ...
      return (
        l.forEach(function (f) {
          var h = ['left', 'top'].indexOf(f) !== -1 ? 'primary' : 'secondary'
          p = le({}, p, u[h](f))
        }),
        (e.offsets.popper = p),
        e
    ...
    function dr(e, t, n) {
      ...
      if (!k.nullOrUndefined(i)) {
        if (k.defined(c)) {
          if (k.array(c) || k.plainObject(c)) return ua(c, l, i)
        } else return ie(l, i)
        return !1
      }
    ...
    function mr(e) {
      return function (t) {
        ...
        return k.array(e)
          ? ie(e, r) ||
              e.some(function (o) {
                return ie(o, r) || (k.array(r) && fn(r)(o))
              })
          : k.plainObject(e) && e[n]
            ? !!e[n] && ie(e[n], r)
            : ie(e, r)
    ...
    function yr(e) {
      return function (t) {
        return k.array(e)
          ? e.some(function (n) {
              return ie(n, t) || (k.array(t) && fn(t)(n))
            })
          : ie(e, t)
      }
    }
    ...
    function fa(e, t) {
      ...
      var n = function (u, f) {
          try {
            return dr(e, t, { key: u, type: 'added', value: f })
          } catch {
            return !1
          }
        },
        r = function (u, f, h) {
          try {
            var d = Te(e, u),
              ...
              b = k.defined(h)
            if (S || b) {
              var R = b ? ot(h, d) : !ot(f, d),
                m = ot(f, g)
              return R && m
            }
            return [d, g].every(k.array) || [d, g].every(k.plainObject)
              ? !ie(d, g)
              : d !== g
          } catch {
            return !1
        ...
        p = function (u, f) {
          try {
            return dr(e, t, { key: u, type: 'removed', value: f })
          } catch {
            return !1
          }
        }
    ...
    function xa(e) {
      var t = (0, en.default)(Ra, e.options || {})
      return {
        wrapper: {
          cursor: 'help',
          display: 'inline-flex',
    ...
    function rn(e, t, n) {
      ...
      if (Rt(e) === 'string') return r(e)
      if (!Bt(e)) return e
      let { children: o } = e.props
      if (Rt(o) === 'string' && o.includes('{step}'))
        return Ft(e, { children: r(o) })
      if (Array.isArray(o))
        return Ft(e, {
          children: o.map(i => (typeof i == 'string' ? r(i) : rn(i, t, n))),
        })
      if (Rt(e.type) === 'function' && !Object.values(e.props).length) {
        let i = e.type({})
        return rn(i, t, n)
      }
      return e
    ...
    function Ge(e, t) {
      var n, r, o, i, a, s
      let c = t ?? {},
        l = It.default.all([$a, Xa(e), c], {
          isMergeableObject: _.plainObject,
        }),
        p = Ja(e, l),
        u = gt(Re(l.target), l.disableScrollParentFix),
        f = It.default.all([
          qa,
      ...
      return (
        ...
        V(
          ...
          V(
            ...
            g && V('h1', { 'aria-label': Se(g), style: d.tooltipTitle }, g),
            V('div', { style: d.tooltipContent }, l)
          ),
          !f &&
            V(
              'div',
              { style: d.tooltipFooter },
              V('div', { style: d.tooltipFooterSpacer }, S.skip),
              S.back,
              S.primary
            ),
          S.close
    ...
    function Ds({ api: e }) {
      let [t, n] = pe(!0),
        ...
        S = tt(() => {
          let x = new URL(window.location.href),
            z = decodeURIComponent(x.searchParams.get('path'))
          ;((x.search = `?path=${z}&onboarding=false`),
            history.replaceState({}, '', x.href),
      ...
      if (
        ...
        ae(() => {
          a(x =>
            ['1:Intro', '5:StoryCreated', '6:FinishedOnboarding'].includes(x)
              ? x
              : u
                ? '4:CreateStory'
                : l
      ...
      let R = h?.sourceFileContent,
        m = R?.lastIndexOf(`export const ${h?.newStoryExportName}`),
        v = R?.slice(m).trim(),
        w = R?.slice(0, m).split(`
`).length,
        U = [
      ...
      return y.createElement(
        ...
        i === '1:Intro'
          ? y.createElement(ks, { onDismiss: () => a('2:Controls') })
          : y.createElement(ws, {
              step: i,
              steps: U,
              onClose: S,
      ...
      go = ue(() => {
        ...
        ;((So = Object.create),
          ...
          (ce = (e, t) =>
            function () {
              return (
                t || (0, e[Rr(e)[0]])((t = { exports: {} }).exports, t),
                t.exports
              )
            }),
          (Co = (e, t, n, r) => {
            if ((t && typeof t == 'object') || typeof t == 'function')
              for (let o of Rr(t))
                !Io.call(e, o) &&
                  ...
                  Pr(e, o, {
                    get: () => t[o],
                    enumerable: !(r = wo(t, o)) || r.enumerable,
                  })
            return e
          }),
          (We = (e, t, n) => (
          ...
          (Po = ce({
            '../../node_modules/scroll/index.js'(e, t) {
              ...
              function a(l) {
                return function (p, u, f, h) {
                  ;((f = f || {}),
                    typeof f == 'function' && ((h = f), (f = {})),
                    typeof h != 'function' && (h = c))
                  var d = i(),
                    g = p[l],
                    S = f.ease || s,
                    b = isNaN(f.duration) ? 350 : +f.duration,
                    R = !1
          ...
          (on = ce({
            '../../node_modules/deepmerge/dist/cjs.js'(e, t) {
              ...
              function l(m, v) {
                return v.clone !== !1 && v.isMergeableObject(m)
                  ? b(c(m), m, v)
                  : m
              }
              function p(m, v, w) {
              ...
              function h(m) {
                return Object.keys(m).concat(f(m))
              }
              function d(m, v) {
                try {
                  return v in m
              ...
              function g(m, v) {
                return (
                  d(m, v) &&
                  !(
                    Object.hasOwnProperty.call(m, v) &&
                    Object.propertyIsEnumerable.call(m, v)
                  )
                )
              }
              function S(m, v, w) {
                ...
                return (
                  ...
                  h(v).forEach(function (x) {
                    g(m, x) ||
                      (d(m, x) && w.isMergeableObject(v[x])
                        ? (U[x] = u(x, w)(m[x], v[x], w))
                        : (U[x] = l(v[x], w)))
                  }),
                  U
          ...
          (Ao = ce({
            '../../node_modules/object-assign/index.js'(e, t) {
              ...
              t.exports = a()
                ? Object.assign
                : function (s, c) {
                    for (var l, p = i(s), u, f = 1; f < arguments.length; f++) {
                      l = Object(arguments[f])
                      for (var h in l) r.call(l, h) && (p[h] = l[h])
                      if (n) {
                        u = n(l)
                        for (var d = 0; d < u.length; d++)
                          o.call(l, u[d]) && (p[u[d]] = l[u[d]])
                      }
                    }
                    return p
                  }
...
Valid keys: ` +
          ...
          (Lo = ce({
            '../../node_modules/prop-types/index.js'(e, t) {
              ;((n = xr()), (r = !0), (t.exports = ko()(n.isElement, r)))
              var n, r
            },
          })),
          (jo =
          ...
          (Nn = 'Bc2PgW_p'),
          (Mo = 'Bc2PgW_c'),
          (kn = ['#FFC700', '#FF0000', '#2E3191', '#41BBC7']),
          (Ln = 3500),
          (jn = 0.5),
          (Mn = 150),
          (Dn = 'mix'),
        ...
        I.asyncGeneratorFunction = e => kt(e) === 'AsyncGeneratorFunction'
        ...
        ;((fi = ut && window.Promise), (di = fi ? ui : pi))
        ...
        ;((Gi = {
          ...
          arrow: { order: 500, enabled: !0, fn: ki, element: '[x-arrow]' },
          flip: {
            order: 600,
            enabled: !0,
            fn: ji,
          ...
          (Lt = (function () {
            function e(t, n) {
              ...
              ;(yi(this, e),
                ...
                Object.keys(le({}, e.Defaults.modifiers, o.modifiers)).forEach(
                  function (a) {
            ...
            ht(n, [
              {
                ...
                value: function () {
                  Oe() &&
                    (this.node || this.appendNode(), it || this.renderPortal())
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var r = this.props,
                    o = r.children,
                    i = r.setRef
                  if ((this.node || this.appendNode(), it))
                  ...
                  if (o)
                    if (y.Children.count(o) === 1)
                      if (!y.isValidElement(o))
                        f = y.createElement('span', null, o)
                      else {
                        var h = se.function(o.type) ? 'innerRef' : 'ref'
                        f = y.cloneElement(y.Children.only(o), re({}, h, c))
                      }
                    else f = o
                  return f
                    ? y.createElement(
              ...
              ht(n, [
                  ...
                  value: function (r, o) {
                    if (Oe()) {
                      ...
                      ;((r.wrapperOptions.position !== l.position ||
                        ...
                        this.floaterRef &&
                          (f('status', H.OPENING) || f('status', H.CLOSING)) &&
                          Ca(
                            this.floaterRef,
                            'transitionend',
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (i) {
                      var m = se.undefined(f.offset) ? 0 : f.offset
        ...
        ;((Na = Object.defineProperty),
          (ka = (e, t, n) =>
            t in e
              ...
              : (e[t] = n)),
          (A = (e, t, n) => ka(e, typeof t != 'symbol' ? t + '' : t, n)),
          ($ = {
            INIT: 'init',
            START: 'start',
            STOP: 'stop',
          ...
          (Za = class {
            constructor(e) {
              ;(A(this, 'beaconPopper'),
                ...
                A(this, 'update', o => {
                  ...
                  if (!Ha(o, Ir))
                    throw new Error(
                      `State is not valid. Valid keys: ${Ir.join(', ')}`
                    )
                  this.setState({
                    ...this.getNextState(
                      {
            ...
            getNextState(e, t = !1) {
              ...
              let {
                ...
                f = _.number(e.index) ? e.index : l,
                h = c && !t ? l : Math.min(Math.max(f, 0), p)
              return {
        ...
        ;((cs = ls),
          ...
          (ps = class extends De {
            ...
            componentDidUpdate(e) {
              ...
              let {
                ...
                { changed: d, changedFrom: g } = xt(e, this.props),
                S = s.info(),
                b = o && n !== $.CLOSE && (c > 0 || n === $.PREV),
                R = d('action') || d('index') || d('lifecycle') || d('status'),
                m = g('lifecycle', [L.TOOLTIP, L.INIT], L.INIT),
                v = d('action', [$.NEXT, $.PREV, $.SKIP, $.CLOSE]),
                w = i && c === e.index
              if (
                (v &&
                  (m || w) &&
                ...
                x && Da(U)
                  ? (g('status', B.READY, B.RUNNING) ||
                    ...
                    r({ ...S, step: f, type: fe.STEP_BEFORE })
                  : (console.warn(
                      x ? 'Target not visible' : 'Target not mounted',
                      f
                    ),
                    r({ ...S, type: fe.TARGET_NOT_FOUND, step: f }),
                    i || h.update({ index: c + (n === $.PREV ? -1 : 1) }))
              }
              ;(g('lifecycle', L.INIT, L.READY) &&
                h.update({ lifecycle: Or(f) || b ? L.TOOLTIP : L.BEACON }),
                d('index') &&
                  Le({
                    title: `step:${l}`,
                    data: [{ key: 'props', value: this.props }],
                ...
                d('lifecycle', L.BEACON) &&
                  r({ ...S, step: f, type: fe.BEACON }),
                d('lifecycle', L.TOOLTIP) &&
                  (r({ ...S, step: f, type: fe.TOOLTIP }),
                  p &&
                    this.tooltip &&
                    ((this.scope = new os(this.tooltip, {
          ...
          (ho = class extends De {
            constructor(e) {
              ;(super(e),
                ...
                A(this, 'handleClickOverlay', () => {
                  let { index: a } = this.state,
                    { steps: s } = this.props
                  Ge(this.props, s[a]).disableOverlayClose ||
              ...
              ;((this.store = Qa({ ...e, controlled: r && _.number(o) })),
            ...
            componentDidUpdate(e, t) {
              ...
              let {
                ...
                { changed: b } = xt(e, this.props),
                { changed: R, changedFrom: m } = xt(t, this.state),
                v = Ge(this.props, l[o]),
                w = !oe(u, l),
              ...
              if (
                (w &&
                  (Tr(l, a) ? h(l) : console.warn('Steps are not valid', l)),
                b('run') && (s ? d(c) : g()),
                U)
              ) {
                let ee = _.number(p) && p < c ? $.NEXT : $.PREV
                ;(n === $.STOP && (ee = $.START),
                  [B.FINISHED, B.SKIPPED].includes(i) ||
                    S({
                      action: n === $.CLOSE ? $.CLOSE : ee,
                      index: c,
                      lifecycle: L.INIT,
                    }))
              }
              !r &&
                ...
                this.callback({
                  ...this.state,
                  type: fe.TARGET_NOT_FOUND,
                  step: v,
                }))
              let z = { ...this.state, index: o, step: v }
              if (
                R('action', [$.NEXT, $.PREV, $.SKIP, $.CLOSE]) &&
                R('status', B.PAUSED)
              ) {
              ...
              if (R('status', [B.FINISHED, B.SKIPPED])) {
                ...
                m('status', [B.IDLE, B.READY], B.RUNNING)
                  ? this.callback({ ...z, type: fe.TOUR_START })
                  : (R('status') || R('action', $.RESET)) &&
                    this.callback({ ...z, type: fe.TOUR_STATUS })
              this.scrollToStep(t)
            }
            componentWillUnmount() {
            ...
            scrollToStep(e) {
              ...
              if (r === B.RUNNING && f) {
                ...
                if (n === L.BEACON && S) {
                  let { offsets: R, placement: m } = S
                  !['bottom'].includes(m) &&
                    !h &&
                    (g = Math.floor(R.popper.top - s))
                } else if (n === L.TOOLTIP && b) {
                  let { flipped: R, offsets: m, placement: v } = b
                ...
                ;((g = g >= 0 ? g : 0),
                  r === B.RUNNING &&
                    Wa(g, { element: d, duration: a }).then(() => {
                      setTimeout(() => {
                        var R
                        ;(R = this.store.getPopper('tooltip')) == null ||
                          R.instance.update()
                      }, 10)
                    }))
              }
      ...
      radial-gradient(circle at 75% 75%, #fc521f99 0%, #fc521f77 8%, transparent 20%)`,
          ...
          (xs = te.div(({ visible: e }) => ({
            ...
            h1: {
              fontSize: 45,
              fontWeight: 'bold',
              animation: `${mo} 1.5s 1s backwards`,
            },
          }))),
          (_s = te.div({
            display: 'flex',
