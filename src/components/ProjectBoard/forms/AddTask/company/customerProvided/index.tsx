...
interface CompanyAddTaskCustomerProvidedProps {
  open: boolean
  onClose: () => void
...
> = ({
  ...
  console.log('CompanyAddTaskCustomerProvided - Props received:', {
...
export default CompanyAddTaskCustomerProvided
