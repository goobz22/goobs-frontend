...
interface CalendarTodayIconProps extends React.SVGProps<SVGSVGElement> {
  styles?: IconStyles
}

const CalendarTodayIcon: React.FC<CalendarTodayIconProps> = ({
  styles,
  style = {},
  ...props
}) => {
  const [isHovered, setIsHovered] = useState(false)
  const glyph = SACRED_GLYPHS[20]
