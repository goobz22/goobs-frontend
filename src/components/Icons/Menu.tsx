...
const MenuIcon: React.FC<MenuIconProps> = ({
  ...
  const [glyph, setGlyph] = useState(SACRED_GLYPHS[0]) // Start with first glyph for consistent hydration
  ...
  // Handle client-side random glyph selection after hydration
  useEffect(() => {
    if (sacredtheme) {
      // Set random glyph only on client to avoid hydration mismatch
