...
/**
 * MenuBook Icon Component
 *
 * A customizable book/documentation icon with sacred theming support.
 *
...
interface MenuBookIconProps extends React.SVGProps<SVGSVGElement> {
  /**
...
const MenuBookIcon: React.FC<MenuBookIconProps> = ({
  sacredtheme,
  size = 24,
  style,
  ...props
