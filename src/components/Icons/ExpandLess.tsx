...
interface ExpandLessIconProps extends React.SVGProps<SVGSVGElement> {
  sacredtheme?: boolean
}
...
const ExpandLessIcon: React.FC<ExpandLessIconProps> = ({
  sacredtheme = false,
  style = {},
  ...props
}) => {
  ...
  return (
    ...
    >
      <svg
        ...
        {...props}
      >
        <path d="M480-520 280-320l-56-56 256-256 256 256-56 56-200-200Z" />
      </svg>
      {sacredtheme && (
        <div
          style={{
