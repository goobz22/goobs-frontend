...
class RegistrationStore {
  ...
  public async getRegistrationToken(registrationToken: string): Promise<SpreadErrorMessage | undefined> {
    console.log('Getting registration token for registration token:', registrationToken);
    const result = this.store[registrationToken]?.['registrationToken'];
    console.log('RegistrationToken retrieved with identifier:', registrationToken, 'and value:', result);
  ...
  public async get(registrationToken: string, identifier: string): Promise<SpreadErrorMessage | undefined> {
    console.log('Getting value for registration token:', registrationToken, 'and identifier:', identifier);
    const result = this.store[registrationToken]?.[identifier];
    console.log('Value retrieved with identifier:', identifier, 'and value:', result);
  ...
  public async set(registrationToken: string, value: string, identifier: string): Promise<void> {
    console.log('Setting value for registration token:', registrationToken, 'and identifier:', identifier);
